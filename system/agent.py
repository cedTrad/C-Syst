...
class Agent:
    ...
    def get_report(self):
        ...
        fig0, fig1 = self.report.benchmark(self.agentId, self.symbol)
        fig0.show()
        fig1.show()
        
        fig = self.report.plot_asset(self.agentId, self.symbol)
        fig.show()
        
        fig1, fig2 = self.report.plot_pnl(self.agentId, self.symbol)
        fig1.show()
        fig2.show()
